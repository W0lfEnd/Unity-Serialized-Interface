...
namespace SerializableInterface.Editor
{
    ...
    public class RequireInterfaceDrawer : PropertyDrawer
    {
        ...
        void DrawInterfaceObjectField(Rect position, SerializedProperty property, GUIContent label, Type interfaceType)
        {
            ...
            var newReference = EditorGUI.ObjectField(objectFieldRect, label, oldReference, baseType, true);
            
            if (_selectedObjectByPicker != null && _selectedPropertyPath == property.propertyPath)
            {
                newReference = _selectedObjectByPicker;
